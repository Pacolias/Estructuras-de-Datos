...
public class LinkedDoubleEndedQueue<T> implements DoubleEndedQueue<T> {
    ...
    public void deleteFirst() {
        if(isEmpty())
            throw new EmptyDoubleEndedQueueException("deleteFirst on empty DEQueue");

        if(first == last){ // Un unico elemento
            first = null;
            last = null;
    ...
    public void deleteLast() {
        if(isEmpty())
            throw new EmptyDoubleEndedQueueException("deleteLast on empty DEQueue");
