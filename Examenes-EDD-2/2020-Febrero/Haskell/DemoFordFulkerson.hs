...
> maxFlowMinCut (mkWeightedDiGraphEdges (vertices g) list) "S" "T" ["S","A","F"] -- Este era el que te daban inicialmente, esta mal: maxFlowMinCut g "S" "T" ["S","A","F"]
15
...
> maxFlowMinCut (mkWeightedDiGraphEdges (vertices g2) list2) "S" "T" ["S","A","B","C","D"] -- Mal: maxFlowMinCut g2 "S" "T" ["S","A","B","C","D"]
19
