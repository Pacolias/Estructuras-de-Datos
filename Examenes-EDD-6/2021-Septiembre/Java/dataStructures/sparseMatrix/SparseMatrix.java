...
public class SparseMatrix {
    ...
    public SparseMatrix add(SparseMatrix other){
        ...
        for(Index idx : values.keySet())
            res.set(idx.getRow(), idx.getColumn(), values.get(idx));

        for(Index idx : other.values.keySet())
            res.set(idx.getRow(), idx.getColumn(), other.get(idx.getRow(), idx.getColumn()) + res.get(idx.getRow(), idx.getColumn()));
    ...
    public SparseMatrix transpose(){
        ...
        for(Index idx : values.keySet())
            res.set(idx.getColumn(), idx.getRow(), values.get(idx));
